...
const Home = () => {
  ...
  containerClassName="flex space-x-4 items-center justify-center mt-4"
  pageClassName="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300"
  previousClassName="flex items-center px-6 py-3 bg-red-600 text-white rounded-full hover:bg-red-700 transition-colors"
  nextClassName="flex items-center px-6 py-3 bg-red-600 text-white rounded-full hover:bg-red-700 transition-colors"
  disabledClassName="text-gray-400 cursor-not-allowed"
  activeClassName="bg-red-500 text-white"
  breakClassName="text-gray-500 text-lg"
  pageLinkClassName="font-medium text-lg"
  previousLinkClassName="font-medium text-lg"
  nextLinkClassName="font-medium text-lg"
/>
