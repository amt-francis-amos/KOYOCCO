...
console.log(localStorage.getItem(" authToken"))
      ...
      const response = await axios.post("https://koyocco-frontend.onrender.com/api/auth/bookings", bookingData, {headers:{Authorization: "Bearer " + localStorage.getItem("authToken")}});
